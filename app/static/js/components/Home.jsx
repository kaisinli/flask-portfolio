                ...
                <div className="container-fluid" id="about-main">
                    <div className="row">
                        ...
                        <div className="col-sm-8">
                            ...
                            <p className="about">I am currently a Software Engineer @ <a href = "www.nieslen.com">Nielsen</a>. If you want to collaborate, <Link to='/portfolio' id="lets-talk">check out my work</Link> and <Link to='/contact' id="lets-talk">let's talk</Link>!</p>
