                ...
                <div className="container-fluid" id="about-main">
                    <div className="row">
                        ...
                        <div className="col-sm-8">
                            <p className="about">HIHIHIHIHIHIHIH</p>
                            ...
                            <p className="about">I am currently a Software Engineer @ Signafire. If you want to collaborate, <Link to='/portfolio' id="lets-talk">check out my works</Link> and <Link to='/contact' id="lets-talk">let's talk</Link>!</p>
